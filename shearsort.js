...
window.parallelShearsort = (function() {
    ...
    // Νέα στοιχεία UI για παρακολούθηση επιδόσεων παραλληλισμού
    ...
    const translations = {
        ...
        el: {
            ...
            whyBWTitle: 'Γιατί μάυρα και άσπρα κουτιά',
            whyBWText: 'Ο αλγόριθμος Shearsort ταξινομεί σωστά κάθε είσοδο. Όμως όλες οι είσοδοι μπορούν να αναπαρασταθούν με ακολουθίες από μηδέν και ένα.',
            resetBtn: 'Επαναφορά',
            sortBtn: 'Ταξινόμηση',
            stepBtn: 'ΒπΒ',
            prevBtn: 'Προηγούμενο',
